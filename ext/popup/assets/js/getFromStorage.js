const getFromStorage = async (key) => {
    return new Promise((resolve, reject) => {
        try {
            new Promise((resolve, reject) => { // this is very ugly but this is just to get the settings from localStorage
                try {
                    chrome.storage.sync.get('settings', (value) => {resolve(value['settings'])})
